...
class TestMCPEntrypoints:
    ...
    def test_mcp_server_importable(self):
        mod = importlib.import_module("tv_mcp.mcp.server")
    ...
    def test_mcp_init_exports(self):
        mod = importlib.import_module("tv_mcp.mcp")
...
class TestServiceImports:
    ...
    @pytest.mark.parametrize(
        "module_path",
        [
            "tv_mcp.services.historical",
            "tv_mcp.services.news",
            "tv_mcp.services.ideas",
            "tv_mcp.services.minds",
            "tv_mcp.services.technicals",
            "tv_mcp.services.options",
        ],
    )
    ...
    @pytest.mark.parametrize(
        "module_path",
        [
            "tv_mcp.core.settings",
            "tv_mcp.core.validators",
            "tv_mcp.core.contracts",
        ],
    )
