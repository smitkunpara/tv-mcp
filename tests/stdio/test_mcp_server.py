"""
Tests for the modular MCP server (tv_mcp.mcp) using REAL data for integration.
"""
...
from tv_mcp.mcp.serializers import serialize_error, serialize_success, toon_encode
from tv_mcp.mcp.server import mcp
...
class TestToolHandlerIntegration:
    ...
    def test_get_historical_data_real(self) -> None:
        from tv_mcp.mcp.tools.historical import get_historical_data
    ...
    def test_get_all_indicators_real(self) -> None:
        from tv_mcp.mcp.tools.technicals import get_all_indicators
        result = _run(get_all_indicators(symbol="NIFTY", exchange="NSE"))
        assert "success: true" in result.lower()
        assert "RSI" in result

    def test_get_news_headlines_real(self) -> None:
        from tv_mcp.mcp.tools.news import get_news_headlines
    ...
    def test_get_option_chain_greeks_real(self) -> None:
        from tv_mcp.mcp.tools.options import get_option_chain_greeks
