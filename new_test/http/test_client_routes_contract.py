...
SERVICE_PATCHES: dict[str, str] = {
    "/historical-data": "new_vercel.routers.client.fetch_historical_data",
    "/news-headlines": "new_vercel.routers.client.fetch_news_headlines",
    "/news-content": "new_vercel.routers.client.fetch_news_content",
    "/all-indicators": "new_vercel.routers.client.fetch_all_indicators",
    "/ideas": "new_vercel.routers.client.fetch_ideas",
    "/minds": "new_vercel.routers.client.fetch_minds",
    "/option-chain-greeks": "new_vercel.routers.client.process_option_chain_with_analysis",
}
...
class TestEmptyHeadlinesSentinel:
    ...
    def test_empty_headlines_returns_sentinel(
        ...
        with patch("new_vercel.routers.client.fetch_news_headlines") as mock_svc:
...
class TestOptionsEndpointSuccess:
    ...
    def test_returns_data_key(
        ...
        with patch(
            "new_vercel.routers.client.process_option_chain_with_analysis"
        ) as mock_svc:
